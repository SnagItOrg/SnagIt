# Klup engineering history (archived from CLAUDE.md)

> **STATUS: HISTORICAL SNAPSHOT — NOT CURRENT INSTRUCTIONS.**
> Archived 2026-08-13 during the Prompt H1 documentation pass. This is the
> engineering body of the former root `CLAUDE.md`, preserved verbatim as
> evidence of decisions, defects and fixes from roughly 2026-03 to 2026-08-06.
>
> **Do not execute anything here as a current runbook.** Several sections
> describe state that has since changed — notably the product thesis
> ("deal intelligence" / arbitrage framing), the scraper monitoring model,
> matcher eligibility, migration numbering and the roadmap.
>
> Current authority:
> - Operating guidance: [`CLAUDE.md`](../CLAUDE.md)
> - Technical handover: [`klup-foundation-handover.md`](klup-foundation-handover.md)
> - Documentation map: [`klup-documentation-index.md`](klup-documentation-index.md)
>
> Retained because it is the only record of several defect diagnoses
> (coverage_v2, the scrape quality gate, the reliability fixes, the AI match
> validation pass) that remain technically accurate and useful.
