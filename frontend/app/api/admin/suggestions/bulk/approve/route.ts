...
export async function POST(req: NextRequest) {
  ...
  // Check slug doesn't already exist. The error was previously discarded, so a
  // failed probe read as "available" and the insert proceeded into the unique
  // index `kg_product_slug_key`, turning an intended 409 into a raw 500.
