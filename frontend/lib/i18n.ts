...
export const translations = {
  da: {
    ...
    magicLinkError: 'Vi kunne ikke sende login-linket. Prøv igen om lidt.',
    ...
    // Hardcoded public copy moved here 2026-09-23. `dismiss` already
    // carries 'Luk' and is reused for the panel close button rather than
    // duplicated — one term per concept.
    newWatchlistHeading: 'Ny overvågning',
    deleteWatchlistConfirm: 'Slet overvågning?',
    deleteWatchlistConfirmYes: 'Ja, slet',
    cancel: 'Annuller',
    deleteWatchlist: 'Slet overvågning',
    ...
    sortGroupLabel: 'Sortér annoncer',
    sortDefault: 'Mest relevante',
    sortByValue: 'Bedste prisniveau',
    sortByValueHint: 'Grupperer efter hvor prisen ligger i annoncens eget marked. Priser på tværs af markeder sammenlignes ikke.',
    ...
    populationBasis: 'baseret på {count} observationer i denne population',
    soldCountsReconciled: 'baseret på {filtered} af {raw} registrerede salg · {excluded} udeladt som afvigende priser (IQR)',
    conditionUnknown: 'Ukendt',
    conditionUnavailable: 'Stand oplyses ikke af denne kilde.',
    firstSeenAt: 'Set første gang {date}',
    chartAxisPriceDkk: 'Pris (kr)',
    priceHistoryTitle: 'Prishistorik',
    reviewedBasis: 'Baseret på {count} gennemgået dansk annonce',
    reviewedBasisPlural: 'Baseret på {count} gennemgåede danske annoncer',
    populationReviewedBasis: 'baseret på {count} gennemgåede observationer i denne population',
    verdictBasisDk: 'I forhold til danske udbudspriser',
    verdictBasisDe: 'I forhold til tyske udbudspriser',
    verdictBasisSe: 'I forhold til svenske udbudspriser',
    verdictBasisNo: 'I forhold til norske udbudspriser',
    verdictBasisReverbAsking: 'I forhold til Reverb-udbud',
    priceDataUnavailable: 'Vi kunne ikke hente hele prisgrundlaget for dette produkt lige nu, så vi viser ingen priser her. Annoncerne herunder er upåvirkede.',
    fullRange: 'Hele spændet {low} – {high} kr',
  ...
  en: {
    ...
    magicLinkError: 'We couldn’t send the login link. Try again in a moment.',
    ...
    newWatchlistHeading: 'New watchlist',
    deleteWatchlistConfirm: 'Delete watchlist?',
    deleteWatchlistConfirmYes: 'Yes, delete',
    cancel: 'Cancel',
    ...
    sortGroupLabel: 'Sort listings',
    sortDefault: 'Most relevant',
    sortByValue: 'Best price level',
    sortByValueHint: 'Groups by where the price sits in each listing’s own market. Prices are not compared across markets.',
    ...
    populationBasis: 'based on {count} observations in this population',
    soldCountsReconciled: 'based on {filtered} of {raw} recorded sales · {excluded} excluded as outliers (IQR)',
    conditionUnknown: 'Unknown',
    conditionUnavailable: 'This source does not state condition.',
    firstSeenAt: 'First seen {date}',
    chartAxisPriceDkk: 'Price (kr)',
    priceHistoryTitle: 'Price history',
    reviewedBasis: 'Based on {count} reviewed Danish listing',
    reviewedBasisPlural: 'Based on {count} reviewed Danish listings',
    populationReviewedBasis: 'based on {count} reviewed observations in this population',
    verdictBasisDk: 'Compared with Danish asking prices',
    verdictBasisDe: 'Compared with German asking prices',
    verdictBasisSe: 'Compared with Swedish asking prices',
    verdictBasisNo: 'Compared with Norwegian asking prices',
    verdictBasisReverbAsking: 'Compared with Reverb asking prices',
    priceDataUnavailable: 'We could not read the full price basis for this product right now, so no prices are shown here. The listings below are unaffected.',
    fullRange: 'Full range {low} – {high} kr',
